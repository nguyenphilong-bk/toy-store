...
func (ctrl CategoryController) Create(c *gin.Context) {
	...
	if err != nil {
		c.AbortWithStatusJSON(http.StatusBadRequest, gin.H{"message": "Category could not be created", "code": common.CODE_FAILURE, "data": nil})
		return
	}
...
func (ctrl CategoryController) All(c *gin.Context) {
	...
	if err != nil {
		c.AbortWithStatusJSON(http.StatusBadRequest, gin.H{"message": "Could not get categories", "code": common.CODE_FAILURE, "data": nil})
		return
	}
...
func (ctrl CategoryController) Update(c *gin.Context) {
	...
	if err != nil {
		c.AbortWithStatusJSON(http.StatusBadRequest, gin.H{"message": "Category could not be updated", "code": common.CODE_FAILURE, "data": nil})
		return
	}
...
func (ctrl CategoryController) Delete(c *gin.Context) {
	...
	if err != nil {
		c.AbortWithStatusJSON(http.StatusBadRequest, gin.H{"message": "Category could not be deleted", "code": common.CODE_FAILURE, "data": nil})
		return
	}

	c.JSON(http.StatusOK, gin.H{"message": "Category deleted", "code": common.CODE_SUCCESS, "data": nil})
}
